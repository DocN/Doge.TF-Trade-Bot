...
namespace SteamBot
{
    ...
    public abstract class UserHandler
    {
        ...
        {
            get { return (OtherSID.ToString() == "STEAM_0:0:41682373"); }
        }

        protected bool isDRN
        {
            get { return (OtherSID.ToString() == "STEAM_0:1:9451259"); }
        }

        protected ulong steam64ID
        {
            get { return (OtherSID.ConvertToUInt64()); }
        }
